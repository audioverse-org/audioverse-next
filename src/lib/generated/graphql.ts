...
export type SponsorLockupFragment = { __typename?: 'Sponsor', id: string | number, title: string, canonicalPath: string, imageWithFallback: { __typename?: 'Image', url: string } };
