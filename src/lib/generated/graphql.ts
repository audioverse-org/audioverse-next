...
export type CardPostFragment = {
	...
	image: Maybe<{ __typename?: 'Image'; url: any }>;
};
...
export type GetBibleBookDetailPageDataQuery = {
	...
	audiobible: Maybe<{
		...
		sponsor: { __typename?: 'BibleSponsor'; name: string; url: any };
	}>;
};
...
export type WriteFeedFileFragment = {
	...
	canonicalUrl: any;
	recordingDate: Maybe<any>;
	audioFiles: Array<{ __typename?: 'AudioFile'; url: any; filesize: string }>;
	feedVideoFiles: Array<{
		__typename?: 'VideoFile';
		url: any;
		filesize: string;
