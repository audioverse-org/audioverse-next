...
export type GetSectionFeaturedTeachingsQueryVariables = Types.Exact<{
...
export const useGetSectionFeaturedTeachingsQuery = <
      TData = GetSectionFeaturedTeachingsQuery,
      TError = unknown
    >(
      variables: GetSectionFeaturedTeachingsQueryVariables,
      options?: UseQueryOptions<GetSectionFeaturedTeachingsQuery, TError, TData>
    ) =>
    useQuery<GetSectionFeaturedTeachingsQuery, TError, TData>(
      ['getSectionFeaturedTeachings', variables],
      graphqlFetcher<GetSectionFeaturedTeachingsQuery, GetSectionFeaturedTeachingsQueryVariables>(GetSectionFeaturedTeachingsDocument, variables),
      options
    );
export const useInfiniteGetSectionFeaturedTeachingsQuery = <
      TData = GetSectionFeaturedTeachingsQuery,
      TError = unknown
    >(
      pageParamKey: keyof GetSectionFeaturedTeachingsQueryVariables,
      variables: GetSectionFeaturedTeachingsQueryVariables,
      options?: UseInfiniteQueryOptions<GetSectionFeaturedTeachingsQuery, TError, TData>
    ) =>{
    
    return useInfiniteQuery<GetSectionFeaturedTeachingsQuery, TError, TData>(
      ['getSectionFeaturedTeachings.infinite', variables],
      (metaData) => graphqlFetcher<GetSectionFeaturedTeachingsQuery, GetSectionFeaturedTeachingsQueryVariables>(GetSectionFeaturedTeachingsDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    )};
...
export async function getSectionFeaturedTeachings<T>(
	variables: ExactAlt<T, GetSectionFeaturedTeachingsQueryVariables>
): Promise<GetSectionFeaturedTeachingsQuery> {
	return fetchApi(GetSectionFeaturedTeachingsDocument, { variables });
}