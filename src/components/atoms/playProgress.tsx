...
const PlayProgress: React.FC<Props> = ({
  ...
  return (isCurrentTrack && !isLoading)?(<div className={Styles.loading_indicator}></div>): (
    <div className={Styles.progressContainer}>
      <svg width="24" height="24">
        ...
        {isPlaying ? (
          <>
		     <path stroke={inactiveColor} strokeWidth="2" strokeLinecap="round" d="M8 8v8">
              <animate
                dur="1s"
                attributeType="XML"
                attributeName="d"
            ...
            <path stroke={inactiveColor} strokeWidth="2" strokeLinecap="round" d="M12 6v10">
              <animate
                dur="1s"
                attributeType="XML"
                attributeName="d"
            ...
            <path stroke={inactiveColor} strokeWidth="2" strokeLinecap="round" d="M16 9v7">
              <animate
                dur="1s"
                attributeType="XML"
                attributeName="d"
