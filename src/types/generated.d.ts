...
type BibleBookChapterArgs = {
	id: Scalars['ID'];
};

type BibleChapter = Node & {
...
type BlogPostCanonicalPathArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type BlogPostCanonicalUrlArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};
...
type CatalogHistoryCommentCreateInput = {
	isSticky: InputMaybe<Scalars['Boolean']>;
	/** Can include mentions in the format of @user:[id] (e.g., `@user:123`). */
	message: Scalars['String'];
};

type CatalogHistoryCommentUpdateInput = {
	isSticky: InputMaybe<Scalars['Boolean']>;
	/** Can include mentions in the format of @user:[id] (e.g., `@user:123`). */
	message: Scalars['String'];
};

type CatalogHistoryEntityUnion =
	| Collection
...
type CollectionCanonicalPathArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type CollectionCanonicalUrlArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type CollectionHistoryArgs = {
...
type DistributionAgreement = Node & {
...
type DistributionAgreementHistoryArgs = {
	after: InputMaybe<Scalars['String']>;
	dateRange: InputMaybe<DateRangeInput>;
	first: InputMaybe<Scalars['Int']>;
	isSticky: InputMaybe<Scalars['Boolean']>;
...
type DistributionAgreementRecordingsArgs = {
	after: InputMaybe<Scalars['String']>;
	bibleReferences: InputMaybe<Array<BibleReferenceRangeInput>>;
...
type DistributionAgreementCreateInput = {
...
type DistributionAgreementUpdateInput = {
	isDefault: InputMaybe<Scalars['Boolean']>;
	isHidden: InputMaybe<Scalars['Boolean']>;
	isRetired: InputMaybe<Scalars['Boolean']>;
...
type DistributionAgreementsOrder = {
	direction: OrderByDirection;
...
type FavoriteEntityUnion = Collection | Person | Recording | Sequence | Sponsor;
...
type LicenseDistributionAgreementsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	isDefault: InputMaybe<Scalars['Boolean']>;
	isRetired: InputMaybe<Scalars['Boolean']>;
...
type MediaFileResult = Attachment | AudioFile | VideoFile;
...
type MediaFileUploadPartUploadUrlsArgs = {
	count: Scalars['Int'];
};
...
type MediaFileUploadFinishInput = {
...
type MediaFileUploadStartInput = {
	filename: Scalars['String'];
	filesize: Scalars['String'];
	recordingId: InputMaybe<Scalars['ID']>;
};

type MediaFileUploadsOrder = {
	direction: OrderByDirection;
...
type MediaReleaseFormMediaReleasesArgs = {
	after: InputMaybe<Scalars['String']>;
	collectionId: InputMaybe<Scalars['ID']>;
	first: InputMaybe<Scalars['Int']>;
	offset: InputMaybe<Scalars['Int']>;
...
type MediaReleaseFormCreateInput = {
...
type MediaReleaseFormUpdateInput = {
	/** Required if `type` is `COLLECTION`. */
	collectionId: InputMaybe<Scalars['ID']>;
	isClosed: InputMaybe<Scalars['Boolean']>;
	/** Required if `type` is `RECORDING`. */
...
type MediaReleasePersonCreateInput = {
	/** The first line of the address. Typically the street address or PO Box number. */
...
type MediaReleasePersonUpdateInput = {
	/** The first line of the address. Typically the street address or PO Box number. */
...
type MutationBlogPostCreateArgs = {
	input: BlogPostCreateInput;
};

type MutationBlogPostDeleteArgs = {
	blogPostId: Scalars['ID'];
};

type MutationBlogPostUpdateArgs = {
	blogPostId: Scalars['ID'];
	input: BlogPostUpdateInput;
};

type MutationCatalogHistoryCommentDeleteArgs = {
	catalogHistoryCommentId: Scalars['ID'];
};

type MutationCatalogHistoryCommentUpdateArgs = {
	catalogHistoryCommentId: Scalars['ID'];
...
type MutationCollectionFavoriteArgs = {
	id: Scalars['ID'];
};

type MutationCollectionHistoryCommentCreateArgs = {
	collectionId: Scalars['ID'];
	input: CatalogHistoryCommentCreateInput;
};

type MutationCollectionScreeningLegalOverrideArgs = {
	collectionId: Scalars['ID'];
};

type MutationCollectionUnfavoriteArgs = {
	id: Scalars['ID'];
};
...
type MutationDistributionAgreementCreateArgs = {
	input: DistributionAgreementCreateInput;
};

type MutationDistributionAgreementDeleteArgs = {
	distributionAgreementId: Scalars['ID'];
};

type MutationDistributionAgreementHistoryCommentCreateArgs = {
	distributionAgreementId: Scalars['ID'];
	input: CatalogHistoryCommentCreateInput;
};

type MutationDistributionAgreementUpdateArgs = {
	distributionAgreementId: Scalars['ID'];
	input: DistributionAgreementUpdateInput;
};

type MutationFaqCreateArgs = {
	input: FaqCreateInput;
};

type MutationFaqDeleteArgs = {
	faqId: Scalars['ID'];
};

type MutationFaqUpdateArgs = {
	faqId: Scalars['ID'];
	input: FaqUpdateInput;
};

type MutationFavoriteRecordingArgs = {
	id: Scalars['ID'];
};

type MutationImageUploadArgs = {
	image: Scalars['Upload'];
	imageType: ImageContainer;
};

type MutationLicenseCreateArgs = {
	input: LicenseCreateInput;
};

type MutationLicenseDeleteArgs = {
	licenseId: Scalars['ID'];
};

type MutationLicenseHistoryCommentCreateArgs = {
	input: CatalogHistoryCommentCreateInput;
	licenseId: Scalars['ID'];
};

type MutationLicenseUpdateArgs = {
...
type MutationLoginSocialArgs = {
	input: UserLoginSocialInput;
};

type MutationMediaFileDeleteArgs = {
	mediaFileId: Scalars['ID'];
};

type MutationMediaFileUploadAbortArgs = {
	mediaFileUploadId: Scalars['ID'];
};

type MutationMediaFileUploadAssignArgs = {
	mediaFileUploadId: Scalars['ID'];
	recordingId: Scalars['ID'];
};

type MutationMediaFileUploadFinishArgs = {
	input: MediaFileUploadFinishInput;
	mediaFileUploadId: Scalars['ID'];
};

type MutationMediaFileUploadStartArgs = {
	input: MediaFileUploadStartInput;
};

type MutationMediaReleaseCreateArgs = {
	input: MediaReleaseCreateInput;
};

type MutationMediaReleaseDeleteArgs = {
	mediaReleaseId: Scalars['ID'];
};

type MutationMediaReleaseFormCreateArgs = {
	input: MediaReleaseFormCreateInput;
};

type MutationMediaReleaseFormDeleteArgs = {
	mediaReleaseFormId: Scalars['ID'];
};

type MutationMediaReleaseFormTemplateUpdateArgs = {
	input: MediaReleaseFormUpdateInput;
	language: Language;
	type: MediaReleaseFormType;
};

type MutationMediaReleaseFormUpdateArgs = {
	input: MediaReleaseFormUpdateInput;
	mediaReleaseFormId: Scalars['ID'];
};

type MutationMediaReleaseUpdateArgs = {
	input: MediaReleaseUpdateInput;
	mediaReleaseId: Scalars['ID'];
};

type MutationPageContactSubmitArgs = {
	input: PageContactSubmitInput;
};

type MutationPageCreateArgs = {
	input: PageCreateInput;
};

type MutationPageDeleteArgs = {
	pageId: Scalars['ID'];
};

type MutationPageUpdateArgs = {
	input: PageUpdateInput;
	pageId: Scalars['ID'];
};

type MutationPersonCreateArgs = {
	input: PersonCreateInput;
};

type MutationPersonDeleteArgs = {
	personId: Scalars['ID'];
};

type MutationPersonFavoriteArgs = {
	id: Scalars['ID'];
};

type MutationPersonHistoryCommentCreateArgs = {
	input: CatalogHistoryCommentCreateInput;
	personId: Scalars['ID'];
};

type MutationPersonUnfavoriteArgs = {
	id: Scalars['ID'];
};

type MutationPersonUpdateArgs = {
	input: PersonUpdateInput;
	personId: Scalars['ID'];
};

type MutationPlaylistAddArgs = {
	input: UserPlaylistAddInput;
};

type MutationPlaylistDeleteArgs = {
	playlistId: Scalars['ID'];
};

type MutationPlaylistRecordingAddArgs = {
	playlistId: Scalars['ID'];
	recordingId: Scalars['ID'];
};

type MutationPlaylistRecordingRemoveArgs = {
	playlistId: Scalars['ID'];
	recordingId: Scalars['ID'];
};

type MutationPlaylistUpdateArgs = {
	input: UserPlaylistUpdateInput;
	playlistId: Scalars['ID'];
};

type MutationRecordingArchiveArgs = {
	reason: Scalars['String'];
	recordingId: Scalars['ID'];
};

type MutationRecordingCreateArgs = {
	input: RecordingCreateInput;
};

type MutationRecordingDeleteArgs = {
	recordingId: Scalars['ID'];
};

type MutationRecordingDraftingArgs = {
	finished: Scalars['Boolean'];
	recordingId: Scalars['ID'];
};

type MutationRecordingFavoriteArgs = {
	id: Scalars['ID'];
};

type MutationRecordingHistoryCommentCreateArgs = {
	input: CatalogHistoryCommentCreateInput;
	recordingId: Scalars['ID'];
};

type MutationRecordingPlaybackSessionAdvanceArgs = {
	input: PlaybackSessionAdvanceInput;
	recordingId: Scalars['ID'];
};

type MutationRecordingPlaybackSessionBeginArgs = {
	recordingId: Scalars['ID'];
};

type MutationRecordingPlaybackSessionFinishArgs = {
	recordingId: Scalars['ID'];
};

type MutationRecordingScreeningContentCheckoutCreateArgs = {
	recordingId: Scalars['ID'];
	userId: InputMaybe<Scalars['ID']>;
};

type MutationRecordingScreeningContentCheckoutDeleteArgs = {
	recordingId: Scalars['ID'];
	userId: InputMaybe<Scalars['ID']>;
};

type MutationRecordingScreeningContentEvaluateArgs = {
	approve: Scalars['Boolean'];
	recordingId: Scalars['ID'];
};

type MutationRecordingScreeningContentEvaluationsClearArgs = {
	recordingId: Scalars['ID'];
};

type MutationRecordingScreeningContentMethodsSetArgs = {
	methods: Array<RecordingScreeningMethod>;
	recordingId: Scalars['ID'];
};

type MutationRecordingScreeningContentUnevaluateArgs = {
	recordingId: Scalars['ID'];
	userId: InputMaybe<Scalars['ID']>;
};

type MutationRecordingScreeningIssueCreateArgs = {
	input: RecordingScreeningIssueInput;
	recordingId: Scalars['ID'];
};

type MutationRecordingScreeningIssueDeleteArgs = {
	issueId: Scalars['ID'];
};

type MutationRecordingScreeningIssueUpdateArgs = {
	input: RecordingScreeningIssueInput;
	issueId: Scalars['ID'];
};

type MutationRecordingScreeningLegalCheckoutCreateArgs = {
	recordingId: Scalars['ID'];
	userId: InputMaybe<Scalars['ID']>;
};

type MutationRecordingScreeningLegalCheckoutDeleteArgs = {
	recordingId: Scalars['ID'];
	userId: InputMaybe<Scalars['ID']>;
};

type MutationRecordingScreeningLegalEvaluateArgs = {
	approve: Scalars['Boolean'];
	recordingId: Scalars['ID'];
};

type MutationRecordingScreeningTechnicalCheckoutCreateArgs = {
	recordingId: Scalars['ID'];
	userId: InputMaybe<Scalars['ID']>;
};

type MutationRecordingScreeningTechnicalCheckoutDeleteArgs = {
	recordingId: Scalars['ID'];
	userId: InputMaybe<Scalars['ID']>;
};

type MutationRecordingScreeningTechnicalEvaluateArgs = {
	approve: Scalars['Boolean'];
	recordingId: Scalars['ID'];
};

type MutationRecordingTranscriptDeleteArgs = {
	recordingId: Scalars['ID'];
};

type MutationRecordingTranscriptUpdateArgs = {
	input: TranscriptUpdateInput;
	recordingId: Scalars['ID'];
};

type MutationRecordingTranscriptionRequestArgs = {
	recordingId: Scalars['ID'];
};

type MutationRecordingUnarchiveArgs = {
	recordingId: Scalars['ID'];
};

type MutationRecordingUnfavoriteArgs = {
	id: Scalars['ID'];
};

type MutationRecordingUpdateArgs = {
	input: RecordingUpdateInput;
	recordingId: Scalars['ID'];
};

type MutationSequenceCreateArgs = {
	input: SequenceCreateInput;
};

type MutationSequenceDeleteArgs = {
	sequenceId: Scalars['ID'];
};

type MutationSequenceFavoriteArgs = {
	id: Scalars['ID'];
};

type MutationSequenceHistoryCommentCreateArgs = {
	input: CatalogHistoryCommentCreateInput;
	sequenceId: Scalars['ID'];
};

type MutationSequenceScreeningLegalOverrideArgs = {
	sequenceId: Scalars['ID'];
};

type MutationSequenceUnfavoriteArgs = {
	id: Scalars['ID'];
};

type MutationSequenceUpdateArgs = {
...
type MutationSponsorCreateArgs = {
	input: SponsorCreateInput;
};

type MutationSponsorDeleteArgs = {
	sponsorId: Scalars['ID'];
};

type MutationSponsorFavoriteArgs = {
	id: Scalars['ID'];
};

type MutationSponsorHistoryCommentCreateArgs = {
	input: CatalogHistoryCommentCreateInput;
	sponsorId: Scalars['ID'];
};

type MutationSponsorUnfavoriteArgs = {
	id: Scalars['ID'];
};

type MutationSponsorUpdateArgs = {
	input: SponsorUpdateInput;
	sponsorId: Scalars['ID'];
};

type MutationTestimonyCreateArgs = {
	input: TestimonyCreateInput;
};

type MutationTestimonyDeleteArgs = {
	testimonyId: Scalars['ID'];
};

type MutationTestimonyUpdateArgs = {
	input: TestimonyUpdateInput;
	testimonyId: Scalars['ID'];
};

type MutationUnfavoriteRecordingArgs = {
	id: Scalars['ID'];
};

type MutationUpdateMyProfileArgs = {
...
type MutationUserRecoverArgs = {
	email: Scalars['String'];
};

type MutationUserResetArgs = {
...
type PageCanonicalPathArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type PageCanonicalUrlArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};
...
type PersonCanonicalPathArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type PersonCanonicalUrlArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type PersonCollectionsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
	offset: InputMaybe<Scalars['Int']>;
...
type PlaybackSessionAdvanceInput = {
...
type QueryAdminImageArgs = {
	imageType: ImageContainer;
	name: Scalars['String'];
};

type QueryAdminImagesArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	imageType: ImageContainer;
};

type QueryAudiobibleArgs = {
	id: Scalars['ID'];
};

type QueryAudiobibleChapterArgs = {
	id: Scalars['ID'];
};

type QueryAudiobiblesArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	offset: InputMaybe<Scalars['Int']>;
};

type QueryAudiobookArgs = {
	id: Scalars['ID'];
};

type QueryAudiobookSeriesArgs = {
	id: Scalars['ID'];
};

type QueryAudiobookSeriesesArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
	language: Language;
...
type QueryAudiobookTrackArgs = {
	id: Scalars['ID'];
};

type QueryAudiobookTracksArgs = {
	after: InputMaybe<Scalars['String']>;
	bibleReferences: InputMaybe<Array<BibleReferenceRangeInput>>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
...
type QueryConferenceArgs = {
	id: Scalars['ID'];
};

type QueryConferencesArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
	language: Language;
...
type QueryDistributionAgreementArgs = {
	id: Scalars['ID'];
};

type QueryDistributionAgreementsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	isDefault: InputMaybe<Scalars['Boolean']>;
	isRetired: InputMaybe<Scalars['Boolean']>;
...
type QueryFeaturedBlogPostsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
	language: Language;
...
type QueryFeaturedRecordingsArgs = {
	after: InputMaybe<Scalars['String']>;
	bibleReferences: InputMaybe<Array<BibleReferenceRangeInput>>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
...
type QueryMediaFileUploadsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
...
type QueryMediaReleaseArgs = {
	id: Scalars['ID'];
};

type QueryMediaReleaseFormArgs = {
	id: Scalars['ID'];
};

type QueryMediaReleaseFormTemplatesArgs = {
	language: Language;
};

type QueryMediaReleaseFormsArgs = {
	after: InputMaybe<Scalars['String']>;
	collectionId: InputMaybe<Scalars['ID']>;
...
type QueryMusicAlbumArgs = {
	id: Scalars['ID'];
};

type QueryMusicAlbumsArgs = {
	after: InputMaybe<Scalars['String']>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
	first: InputMaybe<Scalars['Int']>;
...
type QueryMusicTrackArgs = {
	id: Scalars['ID'];
};

type QueryMusicTracksArgs = {
	after: InputMaybe<Scalars['String']>;
	bibleReferences: InputMaybe<Array<BibleReferenceRangeInput>>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
...
type QueryNotificationChannelsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	offset: InputMaybe<Scalars['Int']>;
};
...
type QueryPersonLetterCountsArgs = {
	language: Language;
};
...
type QueryPopularRecordingsArgs = {
	after: InputMaybe<Scalars['String']>;
	bibleReferences: InputMaybe<Array<BibleReferenceRangeInput>>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
...
type QueryRecordingArgs = {
	allowArchived: InputMaybe<Scalars['Boolean']>;
	id: Scalars['ID'];
};

type QueryRecordingScreeningIssueTypeArgs = {
	id: Scalars['ID'];
};

type QueryRecordingScreeningIssueTypesArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	offset: InputMaybe<Scalars['Int']>;
};
...
type QuerySermonArgs = {
	id: Scalars['ID'];
};

type QuerySermonsArgs = {
	after: InputMaybe<Scalars['String']>;
	bibleReferences: InputMaybe<Array<BibleReferenceRangeInput>>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
...
type QuerySponsorArgs = {
	id: Scalars['ID'];
};

type QuerySponsorLetterCountsArgs = {
	language: Language;
};

type QuerySponsorsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
	language: Language;
...
type QueryStoryProgramArgs = {
	id: Scalars['ID'];
};

type QueryStoryProgramsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
	language: Language;
...
type QueryStorySeasonArgs = {
	id: Scalars['ID'];
};

type QueryStorySeasonsArgs = {
	after: InputMaybe<Scalars['String']>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
	first: InputMaybe<Scalars['Int']>;
...
type QueryWebsiteRecentRecordingsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	language: Language;
	offset: InputMaybe<Scalars['Int']>;
...
type RecordingAttachmentsArgs = {
	allowedContainers: InputMaybe<Array<MediaFileContainer>>;
};

type RecordingAudioFilesArgs = {
	allowedContainers: InputMaybe<Array<MediaFileContainer>>;
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
};

type RecordingBibleReferencesArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	offset: InputMaybe<Scalars['Int']>;
};

type RecordingCanonicalPathArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type RecordingCanonicalUrlArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type RecordingHistoryArgs = {
	after: InputMaybe<Scalars['String']>;
	dateRange: InputMaybe<DateRangeInput>;
	first: InputMaybe<Scalars['Int']>;
	isSticky: InputMaybe<Scalars['Boolean']>;
...
type RecordingPersonsArgs = {
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
	role: InputMaybe<PersonsRoleField>;
};

type RecordingRecordingTagSuggestionsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	offset: InputMaybe<Scalars['Int']>;
};

type RecordingRecordingTagsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	offset: InputMaybe<Scalars['Int']>;
};

type RecordingScreeningIssuesArgs = {
	after: InputMaybe<Scalars['String']>;
...
enum RecordingContentScreeningStatus {
	 ...
	 * @deprecated To be replaced by `PREAPPROVED`.
	 */
...
type RecordingScreeningCheckoutInput = {
	userId: Scalars['ID'];
};
...
type RecordingScreeningIssue = Node & {
...
type RecordingScreeningIssueInput = {
	/** In HH:mm:ss format. */
...
type RecordingScreeningIssueOrder = {
	direction: OrderByDirection;
...
type RecordingScreeningIssueType = Node & {
...
type SequenceCanonicalPathArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type SequenceCanonicalUrlArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type SequenceHistoryArgs = {
	after: InputMaybe<Scalars['String']>;
	dateRange: InputMaybe<DateRangeInput>;
	first: InputMaybe<Scalars['Int']>;
	isSticky: InputMaybe<Scalars['Boolean']>;
...
type SponsorCanonicalPathArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type SponsorCanonicalUrlArgs = {
	useFuturePath?: InputMaybe<Scalars['Boolean']>;
};

type SponsorCollectionsArgs = {
	after: InputMaybe<Scalars['String']>;
	contentType: InputMaybe<CollectionContentType>;
	first: InputMaybe<Scalars['Int']>;
	includeUnpublished: InputMaybe<Scalars['Boolean']>;
...
type SponsorDistributionAgreementsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	isDefault: InputMaybe<Scalars['Boolean']>;
	isRetired: InputMaybe<Scalars['Boolean']>;
...
type SponsorDistributionAgreementInput = {
	isDefault: InputMaybe<Scalars['Boolean']>;
	isRetired: InputMaybe<Scalars['Boolean']>;
	licenseId: Scalars['ID'];
	summary: InputMaybe<Scalars['String']>;
...
type UserFavoriteRecordingsArgs = {
	after: InputMaybe<Scalars['String']>;
	bibleReferences: InputMaybe<Array<BibleReferenceRangeInput>>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
...
type UserNotificationSubscriptionsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	offset: InputMaybe<Scalars['Int']>;
};
...
type UserPlaylistArgs = {
	id: Scalars['ID'];
};

type UserPlaylistsArgs = {
	after: InputMaybe<Scalars['String']>;
	first: InputMaybe<Scalars['Int']>;
	language: Language;
	offset: InputMaybe<Scalars['Int']>;
...
type UserPlaylistHasRecordingArgs = {
	id: Scalars['ID'];
};

type UserPlaylistRecordingsArgs = {
	after: InputMaybe<Scalars['String']>;
	bibleReferences: InputMaybe<Array<BibleReferenceRangeInput>>;
	collectionId: InputMaybe<Scalars['ID']>;
	collectionIds: InputMaybe<Array<Scalars['ID']>>;
...
type UserPlaylistUpdateInput = {
	isPublic: Scalars['Boolean'];
	summary: InputMaybe<Scalars['String']>;
	title: Scalars['String'];
};

type UserPlaylistsOrder = {
	direction: OrderByDirection;
