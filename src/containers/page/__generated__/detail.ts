...
export type GetCustomDetailPageDataQuery = {
	__typename?: 'Query';
	page: {
		__typename?: 'Page';
		title: string;
...
export type GetCustomDetailPageStaticPathsQuery = {
	__typename?: 'Query';
	pages: {
...
>(
	...
	useQuery<GetCustomDetailPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetCustomDetailPageDataQuery,
			GetCustomDetailPageDataQueryVariables
		>(GetCustomDetailPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetCustomDetailPageStaticPathsQuery, TError, TData>(
		...
		graphqlFetcher<
			GetCustomDetailPageStaticPathsQuery,
			GetCustomDetailPageStaticPathsQueryVariables
		>(GetCustomDetailPageStaticPathsDocument, variables),
		options
	);
