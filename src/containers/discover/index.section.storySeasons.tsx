...
import { GetDiscoverStorySeasonsQuery, useInfiniteGetDiscoverStorySeasonsQuery } from "./__generated__";
...
function NodeStorySeason({ node }: { node: SectionNode<StorySeason> }): JSX.Element {
