...
import { GetDiscoverConferencesQuery, useInfiniteGetDiscoverConferencesQuery } from './__generated__';
...
function NodeConference({ node }: { node: SectionNode<Conference> }): JSX.Element {
