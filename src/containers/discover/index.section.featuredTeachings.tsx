...
import { GetDiscoverFeaturedTeachingsQuery, useInfiniteGetDiscoverFeaturedTeachingsQuery } from "./__generated__";
import Section, { SectionNode } from "./index.section";

function selectFeaturedTeachings(p: GetDiscoverFeaturedTeachingsQuery | undefined) {
