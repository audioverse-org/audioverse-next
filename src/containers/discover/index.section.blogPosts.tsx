...
import { GetDiscoverBlogPostsQuery, useInfiniteGetDiscoverBlogPostsQuery } from "./__generated__";
...
function NodePost({ node }: { node: SectionNode<CardPostFragment> }): JSX.Element {
