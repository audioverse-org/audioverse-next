...
import { GetDiscoverTrendingTeachingsQuery, useInfiniteGetDiscoverTrendingTeachingsQuery } from "./__generated__";
import Section, { SectionNode } from "./index.section";

function selectTrendingTeachings(p: GetDiscoverTrendingTeachingsQuery | undefined) {
    return p?.trendingTeachings.nodes?.map((n) => n.recording);
}

function NodeRecording({ node }: { node: SectionNode<CardRecordingFragment> }): JSX.Element {
