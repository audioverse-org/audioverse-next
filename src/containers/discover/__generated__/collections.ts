...
export type GetDiscoverCollectionsPageDataQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const useGetDiscoverCollectionsPageDataQuery = <
    ...
    useQuery<GetDiscoverCollectionsPageDataQuery, TError, TData>(
      variables === undefined ? ['getDiscoverCollectionsPageData'] : ['getDiscoverCollectionsPageData', variables],
...
export const useInfiniteGetDiscoverCollectionsPageDataQuery = <
    ...
    return useInfiniteQuery<GetDiscoverCollectionsPageDataQuery, TError, TData>(
      variables === undefined ? ['getDiscoverCollectionsPageData.infinite'] : ['getDiscoverCollectionsPageData.infinite', variables],
