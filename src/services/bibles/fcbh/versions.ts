import { IBBBook, IBibleVersion } from '../types';

const OLD_TESTAMENT_BOOKS: IBBBook[] = [
	{
		book_id: 'GEN',
		name: 'GENESIS',
		name_short: 'GENESIS',
...
const NEW_TESTAMENT_BOOKS: IBBBook[] = [
	{
		book_id: 'MAT',
		name: 'MATTHEW',
		name_short: 'MATTHEW',
...
const BOOKS: IBBBook[] = [...OLD_TESTAMENT_BOOKS, ...NEW_TESTAMENT_BOOKS];
...
const versions: IBibleVersion[] = [
	...
	},
	{
		...
		description: '',
		books: NEW_TESTAMENT_BOOKS, // NT Permission Only
		sponsor: FCBH_SPONSOR,
	},
	{
		id: 'ENGESV2',
